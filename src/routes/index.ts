...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/users/login',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    login: {"in":"query","name":"login","required":true,"dataType":"string"},
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/books/:id/books-collection',
            ...(fetchMiddlewares<RequestHandler>(BookController)),
            ...(fetchMiddlewares<RequestHandler>(BookController.prototype.getBooksCollectionbyBookId)),

            async function BookController_getBooksCollectionbyBookId(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    id: {"in":"path","name":"id","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              await templateService.apiHandler({
                methodName: 'getBooksCollectionbyBookId',
                controller,
                response,
                next,
                validatedArgs,
